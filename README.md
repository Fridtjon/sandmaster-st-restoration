...
1. Document the current state of the truck
2. Identify missing, broken, or worn parts
3. Learn about nitro RC cars and what's needed to run them
4. Source replacement parts
5. Restore the truck to running condition
